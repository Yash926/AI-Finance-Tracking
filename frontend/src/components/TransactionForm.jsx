  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div style={{ marginBottom: '12px' }}>
        ...
        <input style={inputStyle} type="number" name="amount" min="0.01" step="0.01"
      ...
      <div style={{ marginBottom: '12px' }}>
        ...
        <input style={inputStyle} type="text" name="description"
          placeholder="Add a note..." value={form.description} onChange={handleChange} />
      </div>
